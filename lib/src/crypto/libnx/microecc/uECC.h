/*
 * micro-ecc - A small ECDH and ECDSA implementation for embedded systems
 *
 * Vendored into chiaki-ng for the libnx crypto backend.
 * Source: https://github.com/kmackay/micro-ecc
 *
 * Copyright 2014, Kenneth MacKay. Licensed under the BSD 2-clause license.
 *
 * Used for ECDH key exchange with secp256k1 curve in PlayStation Remote Play protocol.
 */

/* Include chiaki-ng configuration first */
#include "uECC_config.h"

/* Original micro-ecc license header follows */
/* Copyright 2014, Kenneth MacKay. Licensed under the BSD 2-clause license. */
